...
def make_dir():###今の時間が入った名前のディレクトリを作成
    global new_dir
    bagfiles_path = os.getcwd()
    #print(bagfiles_path)
    dt_now = datetime.datetime.now()
    new_dir =str(bagfiles_path) + "/tcv" + str(dt_now.strftime('%m-%d-%H-%M'))+'/csv/'
...
def pandas_group():
    ...
    for i in range(kaisu):
        ...
        #csv_path = '/t_cog_vel'+str(i)+'.csv' #'SaveFolder/addData2.csv'/cc09-14-20-52/cogvel1.csv
